...
/*!
 * \file    sicherDigger.h
 * \brief   Contains the doxygen main page with a project description
 *
...
#ifndef _SDIG_SICHER_DIGGER_H_
#define _SDIG_SICHER_DIGGER_H_

/*!

\mainpage   Project sicherDigger
